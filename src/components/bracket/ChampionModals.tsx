      ...
      <div className="champion-card">
         ...
         <div className="champ-share-section">
           ...
           <div className="share-buttons">
             ...
             <button onClick={() => window.open(`whatsapp://send?text=My FIFA World Cup 2026 Champion is ${champion.n}! Predict yours at https://saf.net.in/`)}>💬 WhatsApp</button>
             <button onClick={() => window.open(`https://twitter.com/intent/tweet?text=My FIFA World Cup 2026 Champion is ${champion.n}! Predict yours at https://saf.net.in/`)}>𝕏 Twitter</button>
             <button onClick={() => { navigator.clipboard.writeText(`My FIFA World Cup 2026 Champion is ${champion.n}! Predict yours at https://saf.net.in/`); alert("Link copied!"); }}>🔗 Copy Link</button>
           </div>
         </div>
      </div>
    </div>
